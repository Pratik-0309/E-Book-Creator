...
function DashboardPage() {
  ...
  useEffect(() => {
    const fetchBooks = async () => {
      try {
        const res = await axiosInstance.get(API_PATHS.BOOKS.GET_BOOK);
    ...
    <DashboardLayout>
      <div className="w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          <div>
            <h1 className="text-2xl font-bold text-slate-900">All eBooks</h1>
            <p className="text-sm text-slate-600 mt-1">
              Create, edit, manage all your AI-generated ebooks.
            </p>
          </div>
        ...
        {isLoading ? (
          ...
          <div
            className="flex flex-col items-center justify-center py-12 text-center border-2 
      border-dashed border-slate-400 rounded-xl mt-6"
          >
            ...
            <p className="text-slate-500 mb-6 max-w-md">
              You haven't created any E-books yet. Get started by creating your
              first one.
            </p>
            <Button icon={Plus} onClick={handleCreateBookClick}>
